      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='text-sm text-muted-foreground'>
            Lembre-se: você pode utilizar a variável <code className='text-violet-500'>{'{transcription}'}</code> no seu prompt para adicionar o conteúdo da transcrição do vídeo selecionado.
          </p>
        </div>
        ...
        <aside className='w-80 space-y-6'>
          <form className='space-y-6'>
            <label
              htmlFor="video"
              className='border flex rounded-md cursor-pointer aspect-video border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary/5'
            >
            ...
            <div className='space-y-2'>
              ...
              <Textarea 
                ...
                placeholder='Inclua palavras-chave encontradas no vídeo separadas por vírgula (,)'
              />
            </div>
